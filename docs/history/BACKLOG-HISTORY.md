...
- 2026-04-08: rebuilt the clean backlog from git log, old docs salvage, and a
  fresh code audit.
- 2026-04-09: compared `stale-v0.72a-experimental-clean` and recorded reference
  implementations for completed or near-completed items.
- 2026-04-10 through 2026-04-18: refreshed community, eMuleAI, stale-branch,
  Windows/MFC/toolchain, API, dependency, and bug-only passes.
- 2026-04-20: added eMuleAI/mod backlog expansion and explicit beyond-stock
  feature candidates.
- 2026-04-25 through 2026-04-26: refreshed current `main`, eMuleAI v1.4,
  mod-archive, WebServer, persistence, helper-thread, and archive-preview
  findings.
- 2026-05-01: recorded the release-readiness regression scan and REST live proof.
- 2026-05-02: added modern-library hardening items and line-ending
  normalization policy.
- 2026-05-04 through 2026-05-07: consolidated the Release 1 gate view and then
  clarified that broadband is pre-release stabilization, community is test-only,
  and Release 1 docs should avoid duplicated evidence ledgers.
