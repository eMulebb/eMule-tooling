...
[`../docs-clean/INDEX.md`](../docs-clean/INDEX.md). The dated active review is
[`../docs-clean/REVIEW-2026-04-26-main-bug-concurrency-scan.md`](../docs-clean/REVIEW-2026-04-26-main-bug-concurrency-scan.md).
...
|---------|------|---------|
| [BUG-069](../docs-clean/BUG-069.md) | WebServer/static files | Static file requests need final canonical root-containment checks and bounded streaming. |
| [BUG-070](../docs-clean/BUG-070.md) | helper threads | Upload/disk helper shutdown waits should handle worker launch failure. |
| [BUG-071](../docs-clean/BUG-071.md) | server list persistence | `server.met` save and auto-update should use checked atomic promotion. |
| [BUG-072](../docs-clean/BUG-072.md) | Kad persistence | `preferencesKad.dat` and `nodes.dat` should stop saving in place. |
| [BUG-073](../docs-clean/BUG-073.md) | WebServer sessions | Session and bad-login arrays need synchronization across request threads. |
| [BUG-074](../docs-clean/BUG-074.md) | archive preview | The scanner needs real cancellation/lifetime synchronization or retirement. |
