# Release 1.0.1 Community Parity Audit Plan

This plan turns the broad `release/v0.72a-community...main` app delta into an
actionable R-1.0.1 hardening backlog. It is documentation-first: each code or
...
6. Close release.
   - Update [RELEASE-1.0.1](../RELEASE-1.0.1.md) gate statuses only when each
     item contains passing evidence.
   - Update [INDEX](../INDEX.md) counts and status tables after every item
     status change.
   - Tag only after all R-1.0.1 release gates are Done or explicitly Wont-Fix
     by product decision.
...
| Improvements | [FEAT-055](../items/FEAT-055.md) | Improvement ideas are ranked without expanding the R-1.0.1 blocking scope. |
