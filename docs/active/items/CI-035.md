...
- `repos\eMule-build-tests\reports\live-e2e-suite\20260516-213444-eMule-main-release`
...
- [ ] Package paths, SHA-256 hashes, app/build/build-tests/tooling commits,
      certification reports, and child report paths are recorded here and in
...
one aggregate report under `workspaces\v0.72a\state\certification`.
