...
- `repos\eMule-build-tests\reports\live-e2e-suite\20260513-204910-eMule-main-release`
...
- `repos\eMule-build-tests\reports\live-e2e-suite\20260514-115418-eMule-main-release`
  passed focused `shared-files-ui` only. It is not full live release proof.
- `repos\eMule-build-tests\reports\live-e2e-suite\20260514-124016-eMule-main-release`
...
- Those packages remain rehearsal evidence only. Final x64 and ARM64 packages,
  manifests, and SHA-256 hashes must be regenerated from current release-ready
  heads after proof resumes.
...
`0.7.3` release source truth at reviewed `main` proof and treats
`release/v0.72a-broadband` as a stabilization/reference branch, not the beta
tag source.
...
mutable preference metadata, and `eMule-build-tests` now guards the
...
[FEAT-061](../../history/items/FEAT-061.md). `eMule-build-tests` now generates
