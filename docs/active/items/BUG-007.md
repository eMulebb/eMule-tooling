...
Regression coverage is present in `repos\eMule-build-tests\src\ring.tests.cpp`
...
[CI-006](CI-006.md). BUG-007 is closed on the code and regression-test evidence
