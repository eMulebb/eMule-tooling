...
milestone: ~
created: 2026-04-08
source: IDEA-CMAKE.md exploratory build-system adoption idea
---

## Classification

Exploratory idea only. This is not an active implementation plan and is not Release 1 scope. The supported build path remains `repos\eMule-build\workspace.ps1` unless a future active item promotes a narrow CMake slice.
