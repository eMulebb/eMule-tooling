...
Exploratory idea only. This is not an active implementation plan and is not Release 1 scope. The supported build path remains `python -m emule_workspace` unless a future active item promotes a narrow CMake slice.
