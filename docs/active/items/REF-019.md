...
- Latest validation in this R1 pass: `workspace.ps1 validate`,
  `workspace.ps1 build-app -Config Debug -Platform x64`, and
  `workspace.ps1 test -Config Debug -Platform x64` passed.
