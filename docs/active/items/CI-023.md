...
- [x] No post-tag fix regresses the original Release 1.0 gates in the Release
      x64 native replay.
- [x] RELEASE-1.0.1 records final pass/fail state for the post-tag replay.
...
- Residual focused coverage gaps are tracked by [CI-032](CI-032.md) and remain
  R-1.0.1-blocking.
