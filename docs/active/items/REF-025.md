...
- the General-options checkbox, tray special-case behavior, and persisted
  `MiniMule` preference were removed
...
entry as part of the R-1.0.1 legacy disposition gate.
