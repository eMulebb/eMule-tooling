...
- `workspace.ps1 build-app -Config Debug -Platform x64`
  ...
  - The delayed-edit tick-width slice rebuilt the current `Debug|x64` and
    ...
    logs:
    `workspaces\v0.72a\state\build-logs\20260510-062418\summary.json` and
    `workspaces\v0.72a\state\build-logs\20260510-062432\summary.json`.
  - The Kad search metadata pointer-width slice rebuilt the current
    ...
    `workspaces\v0.72a\state\build-logs\20260510-062718\summary.json` and
    `workspaces\v0.72a\state\build-logs\20260510-062728\summary.json`.
  - The CRT allocation hook no-throw pointer slice rebuilt the current
    ...
    warnings. Build logs:
    `workspaces\v0.72a\state\build-logs\20260510-063024\summary.json` and
    `workspaces\v0.72a\state\build-logs\20260510-063038\summary.json`.
...
warning reductions that fall out of R1 hardening and validation work.
