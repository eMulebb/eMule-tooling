...
| [BUG-079](items/BUG-079.md) | Critical | **Done** | WebSocket shutdown can close the termination event while accepted clients still wait on it |
...
| [BUG-087](items/BUG-087.md) | Critical | **Done** | HTTPS WebSocket queued writes can stall after TLS WANT_READ |
| [BUG-088](items/BUG-088.md) | Major | **Done** | WebSocket timeout shutdown leaves global state unsafe for restart |
| [BUG-089](items/BUG-089.md) | Major | Open | UDP control sender can deadlock on exception while holding sendLocker |
| [BUG-090](items/BUG-090.md) | Major | Open | Background refresh completion can wedge when UI PostMessage fails |
| [BUG-091](items/BUG-091.md) | Major | Open | DirectDownload ignores close-time write failures |
...
| [FEAT-045](items/FEAT-045.md) | Major | Passed | REST transfer detail endpoint for controller parity |
| [FEAT-046](items/FEAT-046.md) | Major | Passed | REST server and Kad bootstrap/import APIs |
...
| [FEAT-049](items/FEAT-049.md) | Minor | Passed | Curated REST preference expansion |
...
| [AMUT-002](items/AMUT-002.md) | Major | Passed | aMuTorrent transfer detail hydration |
