...
| [CI-020](items/CI-020.md) | REST and legacy WebServer error-path coverage gate | In Progress | tests `36a612a`, `f12b49d`; live 500/503 fault-injection evidence pending |
