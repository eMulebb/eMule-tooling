...
| [CI-021](items/CI-021.md) | WebSocket and legacy socket leak-churn gate | In Progress | tests `1d97dd4`, `e88e067`, `ae3a840`, build `94d1044`; HTTPS smoke artifact passed, HTTP/HTTPS soak thresholds pending |
