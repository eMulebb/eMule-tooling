...
| [CI-021](items/CI-021.md) | WebSocket and legacy socket leak-churn gate | In Progress | tests `1d97dd4`, `e88e067`, `ae3a840`, `941c439`, `b8729d3`, build `94d1044`; HTTP/HTTPS leak-churn soaks and thread-drain smoke passed, stop-start pending |
