...
| [CI-020](items/CI-020.md) | REST and legacy WebServer error-path coverage gate | In Progress | tests `36a612a`, `f12b49d`, `69b8afa`; app `2263e64`, `4082be7`, `d1c8af6`, `1ca8c63`, `979ae8f`, `ddff25f`, `c6927cb`, `c062058`, `440e5e5`, `5f0689f`; HTTP contract matrix artifact passed, live 500/503 fault-injection evidence pending |
