...
|----|--------|----------|-------|
| `BUG-075` | In Progress | `fcedfe3`, `c8e6609`, `1e2ff57`, `69d9262`, `3c63552` app; `28f17db`, `83093a6`, `c10f2a8`, `8e67131`, `b7406d9`, `957c31a`, `51f8b6b` tests | Explicit destructive REST confirmations, content-type seam coverage, centralized native error envelope, method/API-key failure classification, direct route-failure seam coverage, runtime-style error envelope coverage for missing objects, invalid state, service unavailable, and internal command failure classes, and adapter-specific qBit text/Torznab XML response contracts landed. Live JSON failure smoke and legacy HTML response checks remain open. |
