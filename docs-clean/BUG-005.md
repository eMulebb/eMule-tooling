...
- the incompatibility is understood and already contained by the current guard
  behavior
- fixing it requires protocol/design work, not a narrow hardening patch
- current branch direction does not justify the drift and regression risk for
  this path
