...
| [CI-011](CI-011.md) | Release live E2E umbrella | In Progress | app: `7754d16`; tests: `13f1487`, `1058ac2` focused shared-directory proofs | `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64`; focused proof: `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64 -LiveSuite shared-directories-rest`; cleanup validation: `pwsh -File repos\eMule-build\workspace.ps1 build-tests -Config Debug -Platform x64`; `pwsh -File repos\eMule-build\workspace.ps1 test -Config Debug -Platform x64`; `pwsh -File repos\eMule-build\workspace.ps1 build-app -Config Debug -Platform x64` | Full umbrella still requires `repos\eMule-build-tests\reports\live-e2e-suite-latest\result.json`; focused proof passed in `repos\eMule-build-tests\reports\shared-directories-rest\20260506-202644-eMule-main-release\result.json` with a 325-character Unicode shared root, shared-file listing, persistence, relaunch reload, malformed PATCH errors, and missing-parent root handling; adapter conversion cleanup validated in `workspaces\v0.72a\state\build-logs\20260506-203159`, `repos\eMule-build-tests\reports\native-coverage\20260506-203211-eMulebb-workspace-v0.72a-eMule-main-x64-Debug`, and `workspaces\v0.72a\state\build-logs\20260506-203241` | Blocks tag |
