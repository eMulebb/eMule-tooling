...
| [CI-015](CI-015.md) | REST malformed/concurrent matrix | In Progress | tests: `f6cc0f9`, `75b4ce7` | `pwsh -File repos\eMule-build\workspace.ps1 validate`; `python -m pytest tests\python\test_rest_api_smoke.py -q`; `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64 -LiveSuite rest-api` | `repos\eMule-build-tests\reports\rest-api-smoke\20260506-183055-eMule-main-release`; `repos\eMule-build-tests\reports\live-e2e-suite\20260506-183055-eMule-main-release\result.json`; REST smoke stress completed 9780 requests with 0 failures, 0 timeouts, and 0 non-JSON native REST responses; app closed cleanly after stress in 5386.797 ms | Blocks tag |
