...
| [CI-011](CI-011.md) | Release live E2E umbrella | In Progress | tests: `13f1487`, `1058ac2` focused shared-directory proofs | `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64`; focused proof: `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64 -LiveSuite shared-directories-rest` | Full umbrella still requires `repos\eMule-build-tests\reports\live-e2e-suite-latest\result.json`; focused proof passed in `repos\eMule-build-tests\reports\shared-directories-rest\20260506-202644-eMule-main-release\result.json` with a 325-character Unicode shared root, shared-file listing, persistence, relaunch reload, malformed PATCH errors, and missing-parent root handling | Blocks tag |
