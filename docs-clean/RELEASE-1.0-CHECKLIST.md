...
| [ARR-001](ARR-001.md) | Arr live E2E validation | In Progress | app: `87b6f24`, `385273c`, `324c7f7`; tests: `8786847`, `4e02b3d`, `0fd6e77`, `4339716`, `3c5c963`, `8a85158`, `59f7e6d`, `e78c369` | `pwsh -File repos\eMule-build\workspace.ps1 validate`; `python -m pytest tests\python\test_rest_api_smoke.py -q`; `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64 -LiveSuite rest-api`; pending full Arr: `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64 -LiveSuite prowlarr-emulebb -LiveSuite radarr-sonarr-emulebb` | Direct adapter smoke passed in `repos\eMule-build-tests\reports\rest-api-smoke\20260506-190401-eMule-main-release`; Prowlarr, Radarr, Sonarr, and aggregate Arr artifacts pending | Blocks tag |
