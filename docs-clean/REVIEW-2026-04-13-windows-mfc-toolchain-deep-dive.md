...
### 1. `docs-clean` still overclaimed several removals

The live app tree still contains code that `docs-clean/INDEX.md` had listed as
"already in main":
...
- `docs-clean/INDEX.md`
- `docs-clean/REF-003.md`
- `docs-clean/REF-016.md`
- `docs-clean/REF-020.md`
- `docs-clean/REF-021.md`
- `docs-clean/REF-025.md`
- `docs-clean/REF-026.md`
- `docs-clean/REF-028.md`
- `docs-clean/FEAT-007.md`
- `docs-clean/REF-032.md`
- this review file
